  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Gói bài tập</h1>
      ...
      <Dialog open={open} onOpenChange={setMở}>
        <DialogContent className="max-h-[90vh] max-w-3xl overflow-y-auto">
          ...
          <DialogFooter>
            ...
            <Button onClick={submit}>{editing ? "Lưu" : "Tạo"}</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
...
function ExerciseNameSearch({
  ...
  useEffect(() => {
    function onDoc(e: MouseEvent) {
      if (!wrapRef.current?.contains(e.target as Node)) setMở(false);
    }
