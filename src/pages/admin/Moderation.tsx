    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <Card><CardContent className="p-4">
          <div className="text-xs uppercase tracking-wide text-muted-foreground">Mở</div>
          <div className="mt-1 text-2xl font-bold">{counts.open}</div>
        </CardContent></Card>
        <Card><CardContent className="p-4">
          <div className="text-xs uppercase tracking-wide text-muted-foreground">Đã gỡ</div>
      ...
      <Tabs value={tab} onValueChange={(v) => setTab(v as typeof tab)}>
        <TabsList>
          <TabsTrigger value="open">Mở ({counts.open})</TabsTrigger>
          <TabsTrigger value="removed">Đã gỡ ({counts.removed})</TabsTrigger>
