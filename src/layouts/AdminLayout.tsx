      ...
      <div className="grid min-h-screen w-full lg:grid-cols-[260px_1fr]">
        <aside className="hidden border-r bg-white lg:flex lg:flex-col">
          <div className="flex h-16 items-center gap-2 border-b border-slate-100 px-6">
            <div className="grid h-8 w-8 place-items-center rounded-md bg-emerald-600 text-white font-bold shadow-lg shadow-emerald-600/20">
              O
            </div>
            <div className="leading-tight">
              <div className="text-sm font-bold text-slate-900 uppercase tracking-tight">OmniGym Admin</div>
              <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Control Center</div>
            </div>
          </div>
          <nav className="flex-1 space-y-6 overflow-y-auto p-4 custom-scrollbar">
            {GROUPS.map((group) => (
              <div key={group} className="space-y-1.5">
                <div className="px-3 pb-1 text-[10px] font-bold uppercase tracking-[0.15em] text-slate-400">
                  {GROUPS_LABELS[group]}
                </div>
        ...
        <div className="flex min-w-0 flex-col">
          <header className="flex h-16 items-center justify-between border-b bg-white/60 px-4 backdrop-blur lg:px-8">
            ...
            <Link
              to="/admin/profile"
              className="flex items-center gap-3 rounded-full pl-3 pr-1 py-1 hover:bg-slate-100"
            >
